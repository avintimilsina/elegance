                            ...
                            <div class="flex items-center space-x-6 lg:space-x-8">
                                <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                    <div class="h-64 w-44 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100">
                                        <img src="https://assets.myntassets.com/assets/images/15440290/2021/10/29/fe372184-8e71-4e81-ac85-8574e79b4fef1635485151035-HERENOW-Women-Green-Ethnic-Motifs-Printed-Regular-Gotta-Patt-1.jpg"
                                            alt="" class="h-full w-full object-cover object-center">
                                    </div>
                                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                                        <img src="https://assets.myntassets.com/assets/images/15616828/2021/9/25/2d1cf8e1-9bb9-43a8-9f65-292694d64e611632569923460MyshkaWomenWhitePrintedAnarkaliKurta1.jpg"
                                            alt="" class="h-full w-full object-cover object-center">
                                    </div>
                                </div>
                                ...
                                <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                                        <img src="https://assets.myntassets.com/assets/images/17096098/2022/4/6/b002e1c1-e002-4399-b152-5940190057821649228014174-Anouk-Women-Kurta-Sets-8251649228013531-1.jpg"
                                            alt="" class="h-full w-full object-cover object-center">
                                    </div>
                                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                                        <img src="https://assets.myntassets.com/assets/images/15582372/2022/4/28/b9caf311-155b-4fa3-87bc-d0e7b55027271651116510774-Anouk-Women-Blue--White-Ethnic-Motifs-Printed-Kurta-45116511-1.jpg"
                                            alt="" class="h-full w-full object-cover object-center">
                                    </div>
                                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                                        <img src="https://assets.myntassets.com/assets/images/15561682/2021/9/23/e8a20d6f-2f11-41be-8a62-2cc3f538e1f31632400545040DIVYANKWomenPinkGreyEthnicMotifsYokeEmbroideredKurtawithPala6.jpg"
                                            alt="" class="h-full w-full object-cover object-center">
                                    </div>
                                </div>
                                <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                                        <img src="https://assets.myntassets.com/assets/images/15119222/2021/8/12/dcef005e-2433-4714-a3ee-ffb6c6f57ec71628749028022Kurtas1.jpg"
                                            alt="" class="h-full w-full object-cover object-center">
                                    </div>
                                    <div class="h-64 w-44 overflow-hidden rounded-lg">
                                        <img src="https://assets.myntassets.com/assets/images/9744447/2019/7/10/71a2a013-3472-423a-afe5-fbf63f09c94f1562739684559-HERENOW-Women-Blue--Gold-Toned-Printed-Kurta-with-Sharara--D-1.jpg"
                                            alt="" class="h-full w-full object-cover object-center">
                                    </div>
                                </div>
                            </div>
        ...
        <section aria-labelledby="cause-heading">
            <div class="relative bg-gray-800 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
                ...
                <div class="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                    ...
                    <a href="#"
                        class="mt-8 block w-full rounded-md border border-transparent bg-white py-3 px-8 text-base font-medium text-gray-900 hover:bg-gray-100 sm:w-auto">Read
                        our story</a>
                </div>
            </div>
        </section>
                ...
                <div class="mt-6 grid grid-cols-1 gap-y-10 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-6 lg:gap-x-8">
                    @foreach ($products->take(3) as $product)
                        <div class="group relative">
                            ...
                            <p class="mt-1 text-sm text-gray-500">{{ $product->formatted_amount() }}</p>
                        </div>
                    @endforeach
                </div>

                <div class="mt-6 sm:hidden">
                    <a href="/products" class="block text-sm font-semibold text-indigo-600 hover:text-indigo-500">
                        Browse all favorites
                        <span aria-hidden="true"> &rarr;</span>
                    </a>
                </div>
